...
function preload() {
	...
	anegreya = loadFont("fonts/anegreya-font-family-1687417330-0/anegreya_black-BF6493b7ab1b2e2.ttf");
}
...
function draw() {
	...
	fill(0, 255, 255);
	textSize(25);
	text('Wishing you a very', windowWidth/2, windowHeight/3);
	textSize(35);
	text('HAPPY DIWALI', windowWidth/2, windowHeight/2)
	textSize(20);
	text('From Avanthika Giridhar', windowWidth/2 , (windowHeight*4)/5);
	if(random(1) < 0.03) {
